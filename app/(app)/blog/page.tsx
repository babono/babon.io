        ...
        {posts.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-8">
              Add posts in the Payload admin to display them here.
            </p>
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 max-w-2xl mx-auto">
              ...
              <ol className="text-left text-gray-600 dark:text-gray-300 space-y-2">
                <li>1. Open Payload admin at /admin</li>
                <li className="ml-4">• Create a new Post</li>
                <li className="ml-4">• Fill Title, Slug, Excerpt, Published At, Status</li>
                <li className="ml-4">• Optionally add Tags and Cover Image</li>
                <li>2. Publish the post by setting Status to &quot;Published&quot;</li>
              </ol>
            </div>
          </div>
        ) : (
